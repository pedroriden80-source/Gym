...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $pdo->prepare("INSERT INTO trainer (FirstName, LastName, Specialization, Phone) VALUES (?, ?, ?, ?)");
    if ($stmt->execute([$firstName, $lastName, $spec, $phone])) {
        $message = "Trainer registered successfully! <a href='index.php' class='underline'>Go Home</a>";
    }
}
?>
<!DOCTYPE html>
...
<body class="bg-gray-100 flex items-center justify-center min-h-screen p-6">
    <div class="bg-white p-8 rounded-xl shadow-lg max-w-md w-full">
        <h2 class="text-2xl font-bold mb-4 text-gray-800">Trainer Registration</h2>
        ...
        <form method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="specialization" placeholder="e.g. CrossFit, Yoga" required class="w-full p-2 border rounded">
            </div>
            <div>
